...
Статус разработки: согласно README.md, некоторые функции (отображение паролей, автозамена, уход в трей, кнопка копирования) отмечены как недоделанные (❌). Актуальные коммиты от 22 апреля 2026 года показывают активную доработку (redesign and many futures, add email recovery).
